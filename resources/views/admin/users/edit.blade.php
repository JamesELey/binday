...
<head>
    ...
    <title>Edit User - BinDay Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="card">
            <form method="POST" action="{{ route('admin.users.update', $user) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" name="address" placeholder="Full address including postcode">{{ old('address', $user->address) }}</textarea>
                </div>
                        ...
                        @forelse($areas as $area)
                            <div class="area-checkbox">
                                <input type="checkbox" 
                                       ...
                                       value="{{ $area->id }}"
                                       {{ in_array($area->id, old('assigned_area_ids', $user->assigned_area_ids ?? [])) ? 'checked' : '' }}>
