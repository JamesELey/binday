...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea whereGeojson($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<AllowedArea>|AllowedArea query()
     ...
     */
    class AllowedArea extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
    ...
    /**
     * App\Models\BinSchedule
     *
     * @property bool $recurs_biweekly
     * @property string|null $start_date
     * @property float|null $lng
     * @property float|null $lat
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property bool $put_out
     * @property bool $bring_back
     * @property string $collection_day
     * @property string $bin_type
     * @property string $address
     * @property string $postcode
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule wherePostcode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereBinType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereCollectionDay($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereBringBack($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule wherePutOut($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereLat($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereLng($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereStartDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule whereRecursBiweekly($value)
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<BinSchedule>|BinSchedule query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class BinSchedule extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
